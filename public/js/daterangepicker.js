...
!function ($, moment) {
    ...
    DateRangePicker.prototype = {
        ...
        clickDate: function (e) {
            ...
            this.rightCalendar.month.month(this.endDate.month()).year(this.endDate.year());
            this.updateCalendars();
            //endDate.endOf('day');//周兴宇 2014-09-02 18:00:00添加 为解决结束日期确定后的23:59:59
            if (this.singleDatePicker)
                this.clickApply();
            return false; //周兴宇 2014-08-30 12:05:00添加 为解决ie8上 点击日期 使其消失的情况
        },

        clickApply: function (e) {
            this.updateInputText();
            this.hide();
            this.cb(this.startDate, this.endDate); //周兴宇 2014/08/29 13:55:00 添加  为解决点击空间然后点击确定（默认时间） 无法启动回调的情况
            this.element.trigger('apply.daterangepicker', this);
        },
