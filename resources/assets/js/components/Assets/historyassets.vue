    ...
    export default{
        ...
        data(){
            return {
                ...
                value6:"",
                url:"/api/Assets/GetHistoryAssets",
                txtdate:'',
                parentselect:[],
                childselect:[],
                debits: {
        ...
        methods: {
            ...
            query(){
                ...
                if(str!='') {
                    this.getTotal(str);
                    this.url = '/api/Assets/GetHistoryAssets?' + str;
            ...
            exports(){
                var str=this.condition();
                location.href='/HistoryAssetsExcel?'+str;
            },
            page(data) {
                this.datas = data;
            },
            ...
            getTotal(str){
                axios.get('/api/Total/totalhistoryassets?'+str).then(response =>{
                    //alert('aaa');
