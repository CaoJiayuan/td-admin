    ...
    <div class="row wrapper border-bottom white-bg page-heading">
      <div class="col-lg-8">
        ...
        <ol class="breadcrumb">
          ...
          <li class="active"><strong>新增独家专栏</strong></li>
        </ol>
      </div>
      ...
      <div class="form-group text-right col-lg-4">
        <div class="title-action">
            ...
            <button @click="createScoop" type="button" class="btn btn-info" >确定</button>
...
<script>
  ...
  export default{
    ...
    methods   : {
      ...
      dateChange(date) {
        this.scoops.published_at = date;
      },
      createScoop(){
        axios.post('/api/news/createScoop',this.scoops).then(response =>{
