            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-8">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active"><strong>编辑招聘信息</strong></li>
                    </ol>
                </div>
                <div class="col-lg-4">
                    <div class="title-action">
                        <a class="button btn btn-info" @click="preservation">保存</a>
                        <router-link to="/recruits"><a class="button btn btn-danger">取消</a></router-link>
                    </div>
                </div>
            </div>
        </div>
...
<script>
  export default{
    ...
    methods: {
      getContact(){
        axios.get('/api/recruits/edit/'+this.$route.params.id).then(response => {
      ...
      preservation(){
        axios.post('/api/recruits/edit', this.recruit).then(response => {
