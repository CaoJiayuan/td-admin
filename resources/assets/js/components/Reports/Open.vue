        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-8">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active"><strong>开户人数统计</strong></li>
                </ol>
            </div>
        </div>
                        ...
                        <div class="ibox-content">
                            <table class="table table-bordered dataTable">
                                ...
                                <tr>
                                    ...
                                    <order-thead :column="'num'" :url="url" :tTitle="'开户人数'"></order-thead>
                                    <th>操作</th>
                                </tr>
                                </thead>
                                <tbody>
                                <tr v-for="val in datas">
                                    ...
                                    <td>
                                        <router-link :to="{ name: 'OpenDetail', params: { date: val.date,begin:dbegin,end:dend }}">
    ...
    export default{
        ...
        methods: {
            query(){
                ...
                this.dend=end;
                if(timearr!='') {
                    this.url = '/api/Statistics/Open?begin=' + begin + '&end=' + end;
            ...
            exports()
            {
                location.href='/OpenExcel?begin='+this.dbegin.toString().replace('///g','-')+'&end='+this.dend.toString().replace('///g','-');
            },
            page(data) {
                this.datas = data;
            }
