        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-8">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active"><strong>交易手数统计</strong></li>
                </ol>
            </div>
        </div>
                        ...
                        <div class="ibox-content">
                            <table class="table table-bordered dataTable">
                                ...
                                <tr>
                                    ...
                                    <order-thead :column="'num'" :url="url" :tTitle="'交易手数'"></order-thead>
                                    <th>操作</th>
                                </tr>
                                </thead>
                                <tbody>
    ...
    export default{
        ...
        data(){
            return {
                ...
                value6:"",
                url:"/api/Statistics/TranscationOLD",
                dbegin:'',
                dend:'',
            }
        },
        ...
        methods: {
            query(){
                ...
                this.dend=end;
                if(timearr!='') {
                    this.url = '/api/Statistics/TranscationOLD?begin=' + begin + '&end=' + end;
