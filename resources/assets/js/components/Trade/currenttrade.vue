                            ...
                            <div class="col-md-12" style="padding-bottom:8px">
                                <div class="row" style="margin-left: 1px;">
                                    <div class="col-md-12">
                                        ...
                                        <div  class="col-md-3">
                                            <!--<select style="display: none;"  class="form-control" id="selecttradetype">
...
<script>
    ...
    export default{
        ...
        methods: {
            ...
            query(){
               var str= this.condition();
                if(this.str!='') {
                    this.getTotal(str);
                    this.url = '/api/Trade/GetTradeData?' + str;
            ...
            exports(){
                var str= this.condition();
                location.href='/CurrenttradeExcel?' +str;
            },
            condition(){
            ...
            getTotal(str){
                axios.get('/api/Total/totalcurrenttrade?'+str).then(response =>{
                    //alert('aaa');
        ...
        mounted(){
            ...
            //$(".el-input__inner").val('2017-04-17')
